...
exports.cnt_package = exports.stock_unit_status = void 0;
...
class cnt_package {
    ...
    static fromRow(oRow) {
        return new cnt_package(oRow.code || 0, oRow.description || "", oRow.warehouse || "", oRow.status || stock_unit_status.active, oRow.creationDate ? new Date(oRow.creationDate) : new Date(), oRow.dismantleDate ? new Date(oRow.dismantleDate) : null, oRow.products || [], oRow.notes || "");
    }
    // Create an instance from an HTTP request body
    static fromBody(body) {
        return new cnt_package(body.code || 0, body.description || "", body.warehouse || "", body.status || stock_unit_status.active, body.creationDate ? new Date(body.creationDate) : new Date(), body.dismantleDate ? new Date(body.dismantleDate) : null, body.products || [], body.notes || "");
    }
}
exports.cnt_package = cnt_package;
